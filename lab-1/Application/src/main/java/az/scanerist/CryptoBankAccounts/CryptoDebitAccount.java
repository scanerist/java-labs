...
import az.scanerist.ResultTypes.TransferMoneyResults.TransferMoneyNotEnough;
...
import az.scanerist.ResultTypes.WithdrawMoneyResults.NotEnoughMoneyResult;
...
public class CryptoDebitAccount implements ICryptoBankAccount {
    ...
    public CryptoDebitAccount(Float balance, Client client, IBank bank) {
        _id = UUID.randomUUID();
